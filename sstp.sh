...
wget -O /etc/accel-ppp.conf "https://raw.githubusercontent.com/b-a-a/autoscript/main/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/add-sstp https://raw.githubusercontent.com/b-a-a/autoscript/main/add-sstp.sh && chmod +x /usr/bin/add-sstp
wget -O /usr/bin/del-sstp https://raw.githubusercontent.com/b-a-a/autoscript/main/del-sstp.sh && chmod +x /usr/bin/del-sstp
wget -O /usr/bin/check-sstp https://raw.githubusercontent.com/b-a-a/autoscript/main/cek-sstp.sh && chmod +x /usr/bin/check-sstp
wget -O /usr/bin/renew-sstp https://raw.githubusercontent.com/b-a-a/autoscript/main/renew-sstp.sh && chmod +x /usr/bin/renew-sstp
rm -f /root/sstp.sh
